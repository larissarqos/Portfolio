...
if opcao == "Gerar Nuvem de Palavras":
    st.markdown("<h5>Faça o upload de um arquivo .csv com avaliações para gerar a nuvem de palavras</h5>", unsafe_allow_html=True)
    st.markdown("")
...
# -- Opção: Analisar Avaliação
    ...
    st.markdown("<h5>Digite uma avaliação para análise</h5>", unsafe_allow_html=True)
